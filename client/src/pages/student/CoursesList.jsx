  ...
  return (
    <>
      <div className="relative md:px-36 px-8 pt-20 text-left">
        <div className="flex md:flex-row flex-col gap-6 items-start justify-between w-full md:items-center">
          <div>
        ...
        { input && <div className="inline-flex items-center gap-4 px-4 py-2 border border-gray-300 mt-8 -mb-8 text-gray-600">
         <p>{input}</p>
